...
int main() {
	long long int number_to_factorise_n; // 10001111100101011011111111011100011110001100001011100001111
	std::cout << "Enter number to factorise\n";
	std::cin >> number_to_factorise_n; //323324583518541583
	...
	long long int amount_of_measurements = 3;
	...
	std::cout << "\nDivisor: " << bruteforce_factorization_result << " Time: " << time_for_all_tryes[current_measurement] << '\n';
	...
	time_for_all_tryes[current_measurement] = elapsed_time.count();
	std::cout << "\nDivisor: " << ro_pollard_factorization_result << " Time: " << time_for_all_tryes[current_measurement] << '\n';
	...
	start_time = std::chrono::high_resolution_clock::now();
	long long int quadratic_sieve_result = quadratic_sieve_algorithm(number_to_factorise_n);
	end_time = std::chrono::high_resolution_clock::now();
	elapsed_time = end_time - start_time;
	time_for_all_tryes[current_measurement] = elapsed_time.count();
	time_for_all_tryes[amount_of_measurements] += time_for_all_tryes[current_measurement];
	std::cout << "\nDivisor: " << (quadratic_sieve_result == -1 ?  -1 : quadratic_sieve_result) << ' ' << " Time: " << time_for_all_tryes[current_measurement] << '\n';
	std::cout << "Total time:\t" << time_for_all_tryes[amount_of_measurements] << '\n';

	//std::cout << quadratic_sieve_algorithm(9893350372343);
	//std::cout << quadratic_sieve_algorithm(91);
	//std::cout << quadratic_sieve_algorithm(1649);
