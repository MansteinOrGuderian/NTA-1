...
int main() {
	...
	//std::cout << bruteforce_actorization_result << '\n';
	...
	//number_to_factorise_n /= ro_pollard_factorization_result;  // 9893350372343 = 236723 * 41792941
	...
	//long long int current_row = 0, amount_of_B_numbers = 90;
	//std::vector<long long int> vector_of_numbers_of_lines_that_can_use_as_possible_solution{ 85, 87, 90 };
